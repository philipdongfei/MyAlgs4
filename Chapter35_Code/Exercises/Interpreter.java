...
public class Interpreter {
    public static void main(String[] args){
        ...
        while ((line = stdin.readLine()) != null) {
            ...
            //string variable - just print out its value.
            if (tokens.length == 1){
            ...
            //z = x + y
                ...
                double y;
                if (st.contains(yvar)) y = st.get(yvar);
                else                   y = Double.parseDouble(yvar);
                ...
                else throw new RuntimeException("Illegal operator");
                System.out.println(zvar + " = " + st.get(zvar));

            }
            else throw new RuntimeException("Illegal expression");
            System.out.println();
            System.out.print(">> ");
