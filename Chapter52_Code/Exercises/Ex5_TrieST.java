...
public class Ex5_TrieST {
    ...
    public static class TrieIterative<Value>{
        ...
        private class NodeWithInformation {
            ...
            NodeWithInformation(Node node, StringBuilder prefix,
                    int digit, boolean mustBeEqualDigit){
                this.node = node;
                this.prefix = prefix;
                this.digit = digit;
        ...
        public Iterable<String> keysWithPrefix(String prefix){
            ...
            while (!stack.isEmpty()){
                NodeWithInformation currentNodeWithInformation = 
                    stack.pop();
                ...
                //Since we are using a stack to iterate over all keys,
                //start with the last letters in order to get keys
                //in alphabetical order.
                for (char nextChar = R - 1; true; nextChar--){
                    if (currentNode.next[nextChar] != null){
                        stack.push(new NodeWithInformation(currentNode.next[nextChar], new StringBuilder(currentPrefix).append(nextChar)));
                    }
        ...
        // Ordered methods
        // Returns the hightest key in the symbol table smaller than or equal to key.
            ...
            while (!stack.isEmpty()){
                ...
                for (char nextChar = 0; nextChar <= rightChar; nextChar++){
                    if (currentNode.next[nextChar] != null){
                        ...
                        stack.push(new NodeWithInformation(currentNode.next[nextChar], new StringBuilder(currentPrefix).append(nextChar), currentDigit + 1, mustBeEqualDigit));
                    }
                }
            }
            return lastKeyFound;
        ...
        public String max(){
            ...
            while (hasNextCharacter){
                ...
                for (char nextChar = R - 1; true; nextChar--){
                    ...
                    // nextChar value never becomes less than
                    // zero in the for loop, so we need this
                    // extra validation
                    if (nextChar == 0){
                        break;
                    }
    ...
    public static class TernarySearchTrieIterative<Value>{
        ...
        private void updateParentReference(Node parent, Node currentNode,
                Direction direction){
            switch(direction){
        ...
        public Iterable<String> keysWithPrefix(String prefix){
            ...
            Queue<String> otherKeys = collect(nodeWithPrefix.middle,
                ...
                if (currentChar < currentNode.character){
                    ...
                    if (currentChar > currentNode.character){
                        ...
                        rank += getTreeSize(currentNode.left) + 
                            getTreeSize(currentNode.middle);
                        currentNode = currentNode.right;
                    } else if (digit < key.length() - 1){
